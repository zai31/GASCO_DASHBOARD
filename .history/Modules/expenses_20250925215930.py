...
def show_filtered_dashboard():
                    ...
                    if filtered_acc_displays:
                        ...
                        if submit and 'form_data' in locals() and form_data and consumed_now > 0:
                            try:
                                ...
                                row = {
                                    "Cost Center Number": form_data['selected_cc_number'],
                                    ...
                                    "Quarter": get_quarter_from_date(form_data['expense_date']),
    ...
    with tab1:
        # [ ... keep your analysis/plotting code here, properly indented ... ]
        pass
